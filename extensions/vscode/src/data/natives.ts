...
export const NATIVES: NativeDoc[] = [
  ...
  {
    name: "ui.window",
    signature: "ncallr dst, ui.window, html, title",
    doc: "html with the document shell, default stylesheet, browser tab title (<title>), and a styled page frame for title appended.",
  },
  {
    name: "ui.window_end",
    signature: "ncallr dst, ui.window_end, html",
    doc: "html with a frame opened by ui.window closed.",
  },
  {
    name: "ui.card",
    signature: "ncallr dst, ui.card, html, title",
    doc: "html with a bordered content panel for title appended.",
  },
  {
    name: "ui.card_end",
    signature: "ncallr dst, ui.card_end, html",
    doc: "html with a panel opened by ui.card closed.",
  },
  {
    name: "ui.section",
    signature: "ncallr dst, ui.section, html, title",
    doc: "html with an unframed content group for title appended.",
  },
  {
    name: "ui.section_end",
    signature: "ncallr dst, ui.section_end, html",
    doc: "html with a group opened by ui.section closed.",
  },
  {
    name: "ui.row",
    signature: "ncallr dst, ui.row, html",
    doc: "html with a horizontal responsive layout opened.",
  },
  {
    name: "ui.row_end",
    signature: "ncallr dst, ui.row_end, html",
    doc: "html with a layout opened by ui.row closed.",
  },
  {
    name: "ui.column",
    signature: "ncallr dst, ui.column, html",
    doc: "html with a vertical layout opened.",
  },
  {
    name: "ui.column_end",
    signature: "ncallr dst, ui.column_end, html",
    doc: "html with a layout opened by ui.column closed.",
  },
  {
    name: "ui.title",
    signature: "ncallr dst, ui.title, html, value",
    doc: "html with a heading for value appended.",
  },
  {
    name: "ui.text",
    signature: "ncallr dst, ui.text, html, value",
    doc: "html with a paragraph for value appended.",
  },
  {
    name: "ui.field",
    signature: "ncallr dst, ui.field, html, label, value",
    doc: "html with a label/value display row appended.",
  },
  {
    name: "ui.button",
    signature: "ncallr dst, ui.button, html, label, href",
    doc: "html with a link styled as a button appended.",
  },
  {
    name: "ui.form",
    signature: "ncallr dst, ui.form, html, method, action",
    doc: "html with an HTML form opened.",
  },
  {
    name: "ui.form_end",
    signature: "ncallr dst, ui.form_end, html",
    doc: "html with a form opened by ui.form closed.",
  },
  {
    name: "ui.input",
    signature: "ncallr dst, ui.input, html, label, name",
    doc: "html with a labeled text input appended.",
  },
  {
    name: "ui.submit",
    signature: "ncallr dst, ui.submit, html, label",
    doc: "html with a submit button appended.",
  },
